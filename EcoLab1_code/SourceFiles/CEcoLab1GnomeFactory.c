...
#include "CEcoLab1GnomeFactory.h"
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1GnomeFactory_QueryInterface(IEcoComponentFactory* me, const UGUID* riid, void** ppv) {
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoLab1GnomeFactory_AddRef(/* in */ IEcoComponentFactory* me) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoLab1GnomeFactory_Release(/* in */ IEcoComponentFactory* me) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1GnomeFactory_Init(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pIUnkSystem, /* in */ void* pv) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
    int16_t result = -1;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1GnomeFactory_Alloc(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pISystem, /* in */ struct IEcoUnknown *pIUnknownOuter, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
    IEcoUnknown* pIUnk = 0;
    int16_t result = -1;
 ...
 *
 */
char_t* ECOCALLMETHOD CEcoLab1GnomeFactory_get_Name(/* in */ struct IEcoComponentFactory* me) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
 ...
 *
 */
char_t* ECOCALLMETHOD CEcoLab1GnomeFactory_get_Version(/* in */ struct IEcoComponentFactory* me) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
 ...
 *
 */
char_t* ECOCALLMETHOD CEcoLab1GnomeFactory_get_Manufacturer(/* in */ struct IEcoComponentFactory* me) {
    CEcoLab1GnomeFactory* pCMe = (CEcoLab1GnomeFactory*)me;
...
IEcoComponentFactoryVTbl g_x1F5DF16EE1BF43B999A434ED38FE8F3AFactoryVTbl = {
    CEcoLab1GnomeFactory_QueryInterface,
    CEcoLab1GnomeFactory_AddRef,
    CEcoLab1GnomeFactory_Release,
    CEcoLab1GnomeFactory_Alloc,
    CEcoLab1GnomeFactory_Init,
    CEcoLab1GnomeFactory_get_Name,
    CEcoLab1GnomeFactory_get_Version,
    CEcoLab1GnomeFactory_get_Manufacturer
};
 ...
 *
 */
CEcoLab1GnomeFactory g_x1F5DF16EE1BF43B999A434ED38FE8F3AFactory = {
    &g_x1F5DF16EE1BF43B999A434ED38FE8F3AFactoryVTbl,
    0,
    (CreateInstance) createCEcoLab1Gnome,
    (InitInstance) initCEcoLab1Gnome,
    "EcoLab1Gnome\0",
    "1.0.0.0\0",
    "VeryaskinDV\0"
};
