...
#ifndef __C_ECOLAB1INSERTION_FACTORY_H__
#define __C_ECOLAB1INSERTION_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoLab1InsertionFactory {
...
} CEcoLab1InsertionFactory;

#endif /* __C_ECOLAB1INSERTION_FACTORY_H__ */
