...
#ifndef __C_ECOLAB1GNOME_FACTORY_H__
#define __C_ECOLAB1GNOME_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoLab1GnomeFactory {
...
} CEcoLab1GnomeFactory;

#endif /* __C_ECOLAB1GNOME_FACTORY_H__ */
